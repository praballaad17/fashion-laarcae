  ...
  useEffect(() => {
    const getProduct = async () => {
      try {
        ...
        setBigImg(resproduct.data[0].product_images_1);
      } catch (error) {
        console.log(error);
      }
    };
                        ...
                        <div className="thumnail-image fix">
                          <ul className="tab-menu nav">
                            <li>
                              <a
                                onClick={() => {
                                  setBigImg(product.product_images_1);
                                }}
                              >
                                <img alt="" src={product.product_images_1} />
                              </a>
                            </li>
                            <li>
                              <a
                                className="active"
                                onClick={() => {
                                  setBigImg(product.product_images_2);
                                }}
                              >
                                <img alt="" src={product.product_images_2} />
                              </a>
                            </li>
                            <li>
                              <a
                                onClick={() => {
                                  setBigImg(product.product_images_3);
                                }}
                              >
                                <img alt="" src={product.product_images_3} />
                              </a>
                            </li>
                          </ul>
                        </div>
                  ...
                  <div className="text-sin">
                    ...
                    >
                      <Tab eventKey="Description" title="Description">
                        <div
                          className="tab-pane active sin-ha"
                          id="Description"
                        >
